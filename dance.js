...
function displayGemToElf(elf, gem) {
  try {
      if (elf.favouriteGems == gem)
        return AboveHandUp(elf).then(AboveHandDown); 
      if (elf.dislikedGems == gem)
        return AboveHandDown(elf).then(AboveHandUp);
